...
class PengujianController extends Controller
{
    ...
    public function index()
    {
        ...
        ->where('log_aduans.bidang', '=', 'Bidang Pengujian')
        ...
        return view('pengujian.index', compact($compact))
        ->with('nodisposisi',1);
    }
    ...
    public function show($id)
    {
        ...
        return view('pengujian.detail', compact($compact));
    }
    ...
    public function upload_laporan(Request $request, $id)
    {
        ...
        return redirect('/disposisi_pengujian');
    }
}