...
class PemeriksaanController extends Controller
{
    ...
    public function index()
    {
        ...
        ->where('log_aduans.bidang', '=', 'Bidang Pemeriksaan')
        ...
        return view('pemeriksaan.index', compact($compact))
        ->with('nodisposisi',1);
    }
    ...
    public function show($id)
    {
        ...
        return view('pemeriksaan.detail', compact($compact));
    }
    ...
    public function upload_laporan(Request $request, $id)
    {
        ...
        return redirect('/disposisi_pemeriksaan');
    }
}