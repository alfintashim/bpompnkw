...
class PenindakanController extends Controller
{
    ...
    public function index()
    {
        ...
        ->where('log_aduans.bidang', '=', 'Bidang Penindakan')
        ...
        return view('penindakan.index', compact($compact))
        ->with('nodisposisi',1);
    }
    ...
    public function show($id)
    {
        ...
        return view('penindakan.detail', compact($compact));
    }
    ...
    public function upload_laporan(Request $request, $id)
    {
        ...
        return redirect('/disposisi_penindakan');
    }
}