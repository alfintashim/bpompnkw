...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{URL::to('/aduan')}}"><i class="fa fa-list-alt"></i> Aduan</a></li>
...
<section class="content">
                        ...
                        <div class="tab-pane active" id="tab_1">
                            <div class="box-header with-border">
                                <div class="pull-left btn-group">
                                    <form method="POST" action="{{ URL::to('/aduan/'.$detail_aduan->id.'/proses_aduan') }}">
                                        {{ method_field('PUT') }}
                                        {{ csrf_field() }}  
                                    ...
                                    @if($detail_aduan->status == 'DITERIMA')
                                        ...
                                        <i class="fa fa-mail-forward"></i> Proses/Teruskan 
                                        </button>
                                    @else
                                        <button type="submit" class="btn bg-navy margin" disabled>
                                        <i class="fa fa-mail-forward"></i> Proses/Teruskan 
                                        </button>
                                    @endif
                                    ...
                                    <button type="button" class="btn bg-navy margin" data-toggle="modal" data-target="#modal-ditolak">
                                        <i class="fa fa-remove"></i> Ditolak 
                                    </button>
                                    </form>
                                </div>
                            </div>
 ...
 -->                                </div>
                ...
                <!--          <h4 class="modal-title judul">Hapus</h4>-->
                <!--          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>-->
                <!--        </div>-->
                <!--        <div class="modal-body">-->
                <!--          Anda yakin ingin menghapus <strong><span class="aduan"></span></strong>?-->
                <!--        </div>-->
                ...
                <!-- /modals -->
                        ...
                        <div class="tab-pane" id="tab_2">
                            <div class="box-header with-border">
                                <div class="pull-left btn-group">
                                    <button type="button" class="btn bg-navy margin" data-toggle="modal" data-target="#modal-balas">
                                        <i class="fa fa-reply"></i> Balas </button>
                                </div>
                            </div>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="direct-chat-msg">
                                        ...
                                        {{ $item->pesan }}
                                            ...
                                            <form method="POST" action="{{ URL::to('/aduan/hapus_pesan/'.$item->id) }}">
                                                {{ method_field('DELETE') }}
                                                    {{ csrf_field() }}
...
<!-- BALAS PESAN -->
<form method="POST" action="{{ URL::to('/aduan/'.$detail_aduan->id.'/kirim_pesan') }}">
    {{ csrf_field() }}
    <div class="modal fade" id="modal-balas">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="text" name="isipesan" class="form-control">
                    {{-- <textarea style="resize:none; text-align:left" cols="40" rows="10"></textarea> --}}
                </div>
                <div class="modal-footer">
...
<!-- GANTI STATUS -->
<form method="POST" action="{{ URL::to('/aduan/'.$detail_aduan->id.'/ganti_status') }}">
    {{ method_field('PUT') }}
    {{ csrf_field() }}
...
<!-- DITOLAK -->
<form method="POST" action="{{ URL::to('/aduan/'.$detail_aduan->id.'/status_ditolak') }}">
    {{ method_field('PUT') }}
    {{ csrf_field() }}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Pengaduan Ditolak</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label>Status</label>
                        <input type="text" class="form-control" value="DITOLAK" disabled="">
                    </div>
                    <div class="form-group">
                        <label>Pesan</label>
                        <textarea class="form-control" rows="3" name="pesan">Terima kasih telah mengirimkan laporan pengaduan kepada Balai Besar Pengawasan Obat dan Makanan Kota Pontianak. Laporan anda kami tolak karena kurang lengkapnya informasi yang kami terima.</textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Batal</button>
