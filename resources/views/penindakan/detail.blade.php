...
@section('title')
<title>Detail Disposisi Aduan Bidang Penindakan</title>
@endsection
        ...
        <div class="col-xs-12">
            <div class="box box-default">
                ...
                <div class="box-header with-border">
                    <a href="{{ URL::to('/disposisi_penindakan')}}">
...
<div class="modal fade" id="modal-upload-laporan">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                <form class="form-horizontal" method="POST" action="{{ URL::to('/disposisi_penindakan/'.$disposisi->id.'/upload_laporan') }}" enctype="multipart/form-data">
                    {{ method_field('PUT') }}
                    {{ csrf_field() }}
