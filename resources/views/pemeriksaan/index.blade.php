...
@section('title')
<title>Disposisi Aduan Bidang Pemeriksaan</title>
@endsection
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                <div class="box-body">
                    <h4>
                        Daftar Pengaduan Disposisi Bidang Pemeriksaan
                    </h4>
                </div>
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @if($item->notif == 3 )
                            <tr style="font-weight:bold">
                                ...
                                <td align="center">
                                <div class="btn-group">
                                    <form method="POST" action="{{ URL::to('/disposisi_pemeriksaan/'.$item->id.'/') }}">
                                        {{ method_field('PUT') }}
                                        {{ csrf_field() }}
