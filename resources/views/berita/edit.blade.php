...
@section('title')
<title>Edit Berita | {{ $berita->judul }}</title>
@endsection
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-edit"></i> Edit Berita</li>
    </ol>
</section>
@endsection
            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea id="editor1" class="form-control" name="editor1" rows="10" cols="80">{{ $berita->isi }}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" value="{{ $berita->name }}" readonly>
                        </div>
                    </div>
                    <div class="form-group">
