...
@section('title')
<title>Detail Aduan Disposisi Bidang Infokom</title>
@endsection
                        ...
                        <div class="tab-pane active" id="tab_1">
                            ...
                            <div class="box-header with-border">
                                <div class="pull-left btn-group"> 
                                    <!--<a type="button" class="btn bg-navy margin" href="{{ URL::to('/disposisi_infokom/'.$disposisi->id.'/printpreview') }}">-->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="box-body">
                    ...
                    <form role="form" method="POST" action="{{ URL::to('/disposisi_infokom/'.$disposisi->id.'/teruskan_note_disposisi') }}" enctype="multipart/form-data">
                        {{ method_field('PUT') }}
                        {{ csrf_field() }}
                        <div class="form-group">
...
<!-- GANTI STATUS -->
<form method="POST" action="{{ URL::to('/disposisi_infokom/'.$disposisi->id.'/ganti_status') }}" enctype="multipart/form-data">
    {{ method_field('PUT') }}
    {{ csrf_field() }}
...
<div class="modal fade" id="modal-upload-laporan">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                <form class="form-horizontal" method="POST" action="{{ URL::to('/disposisi_infokom/'.$disposisi->id.'/upload_laporan') }}" enctype="multipart/form-data">
                    {{ method_field('PUT') }}
                    {{ csrf_field() }}
