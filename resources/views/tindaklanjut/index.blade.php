...
@section('title')
<title>Tindak Lanjut Aduan</title>
@endsection
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-list-alt"></i> Tindak Lanjut</li>
    </ol>
</section>
@endsection
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                <div class="box-body">
                    <h4>
                        Daftar Pengaduan yang Membutuhkan Disposisi 
                    </h4>
                </div>
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @if($item->notif == 2)
                            <tr style="font-weight:bold">
                                ...
                                <td align="center">
                                <div class="btn-group">
                                    <form method="POST" action="{{ URL::to('/tindak_lanjut/'.$item->id.'/') }}">
                                        {{ method_field('PUT') }}
                                        {{ csrf_field() }}
