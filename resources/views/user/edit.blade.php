    ...
    <div class="row">
        <div class="col-md-6">
            <div class="box box-info">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{ URL::to('/user/'.$user->username.'/edit') }}">
                    {{ method_field('PUT') }}
                    {{ csrf_field() }}
                <div class="box-body">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="nama" value="{{ $user->name }}" class="form-control" placeholder="Enter ...">
                    </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="username" value="{{ $user->username }}" class="form-control" placeholder="Enter ...">
                        </div>
                    </div>
                    <div class="form-group">
